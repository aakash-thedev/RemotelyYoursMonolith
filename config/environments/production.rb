...
Rails.application.configure do
  ...
  # config.active_job.queue_name_prefix = "RemotelyYoursMonolith_production"
  ...
  config.action_mailer.default_url_options = { host: ENV.fetch("APP_HOST", "remotelyyours.com") }
